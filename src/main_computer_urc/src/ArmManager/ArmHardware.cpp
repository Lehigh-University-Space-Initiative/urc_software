...
public:
    ...
    const hardware_interface::HardwareInfo & info) override
  {
    ...
    RCLCPP_INFO(node_->get_logger(), "ArmHardware initialized. Publisher created for /roverDriveCommands");
  ...
  {
    RCLCPP_INFO(node_->get_logger(), "ArmHardware activated");
    return hardware_interface::CallbackReturn::SUCCESS;
  }
...
PLUGINLIB_EXPORT_CLASS(drive_train_hardware::ArmHardware, hardware_interface::SystemInterface)
